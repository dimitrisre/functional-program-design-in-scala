...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var nB = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  ...
  var aa = new $c_Lcalculator_Signal().init___F0(expr$1);
  $m_Lcalculator_Signal$();
  ...
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1$1, nB$1, aa$1, sqrtDelta$1) {
    return (function() {
      if (($uD(delta$1$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(($uD(nB$1.apply__O()) + $uD(sqrtDelta$1.apply__O())) / $uD(aa$1.apply__O())), (($uD(nB$1.apply__O()) - $uD(sqrtDelta$1.apply__O())) / $uD(aa$1.apply__O()))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(b$1) {
    return (function() {
      return ($uD(b$1.apply__O()) * $uD(b$1.apply__O()))
    })
  })(b));
  var bSquare = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, c$1, bSquare$1) {
    return (function() {
      return ($uD(bSquare$1.apply__O()) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, c, bSquare));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    return new $c_T2().init___O__O(vaR, y)
  } else {
